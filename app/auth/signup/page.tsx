...
import StoreOff from "@/public/svg/store-off.svg";
        ...
        <div className="w-full">
          ...
          <div className="w-full flex px-[450px] justify-between mt-10 font-normal">
            <Link href="/auth/signup">
              {" "}
              <div className=" border relative border-[#603F8B] h-[65px] py-5 px-6 w-fit rounded-[11px]">
                <div className="flex items-center space-x-6">
                  <Image src={Profile} width={24} height={24} alt="some" />
                  <p>Regular User</p>
                </div>
            ...
            <Link href="/auth/signup/sp">
              <div className="flex items-center space-x-6 border border-[#EEEEFF] text-[#B1BDCA] h-[65px] py-5 px-6 w-fit rounded-[11px]">
                <Image src={StoreOff} width={24} height={24} alt="some" />
